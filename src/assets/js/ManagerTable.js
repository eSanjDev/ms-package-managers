                ...
                render(data, type, full) {
                    return flagOnlyTrashed ? `
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="${resourceName}/${full['id']}/edit" class="text-body"><i class="ti ti-edit ti-sm me-2"></i></a>
                            <a href="${resourceName}/${full['id']}/activities" class="text-body"><i class="icon-base ti tabler-logs"></i></a>
                        </div>
                    `;
                }
            }
